...
// Se o usuário clicou no botão cadastrar efetua as ações
   ...
   if (isset($_POST['IdCadastraFaqAux'])){
    ...
    $IdCadastraFaq =    $_POST['IdCadastraFaqAux'];
         ...
         $buscar->set('sql',"SELECT `Imagem1`,`Imagem2`,`Imagem3` FROM `CadastroFAQ` WHERE IdCategoria = '$IdCadastraFaq' ");
         
            if( $retorno = mysql_fetch_object($buscar->executarQuery())){
            	
         	if (($retorno->Imagem1 != null) && ($NomeImagem1 != null)) {
         		unlink($caminho.$retorno->Imagem1);
         	}
         	if (($retorno->Imagem2 != null) && ($NomeImagem2 != null)) {
         		unlink($caminho.$retorno->Imagem2);
         	}
         	if (($retorno->Imagem3 != null) && ($NomeImagem3 != null)) {
            ...
            if (($retorno->Imagem1 != null) && ($NomeImagem1 == null)) {
                $NomeImagem1 = $retorno->Imagem1; 
            }
            if (($retorno->Imagem2 != null) && ($NomeImagem2 == null)) {
                $NomeImagem2 = $retorno->Imagem2;
            }
            if (($retorno->Imagem3 != null) && ($NomeImagem3 == null)) {
                $NomeImagem3 = $retorno->Imagem3; 
            }
          }
         	...
         	/********************************************************************************************/
         $insereFAQ->set('sql',"UPDATE CadastroFAQ SET
         												 NomeFaq = '$NomeFaq',
         												 Imagem1 = '$NomeImagem1',
										         		 Imagem2 = '$NomeImagem2',
										         		 Imagem3 = '$NomeImagem3',
         	...
         	echo("<script type='text/javascript'> location.href='../../FAQ-Cadastro.php'; alert('Dados Atualizados com sucesso'); </script>");
         
         }else{
         	echo("<script type='text/javascript'> location.href='../../FAQ-Cadastro.php'; alert('Dados não Atualizados'); </script>");
         }         
