...
if (isset($_GET['IdTarefaAux'],$_GET['IdEtapaTarefaAux'],$_GET['status'])) {

          $IdEtapaTarefa = $_GET['IdEtapaTarefaAux'];
          $Status = $_GET['status'];

          $insereEtapa->set('sql',"UPDATE EtapaTarefa SET SituacaoEtapaTarefa = '$Status'
   ...
   echo("<script type='text/javascript'> location.href='../../tarefa-visualizar.php'; alert('Etapa finalizada com sucesso'); </script>");
}else{
    echo("<script type='text/javascript'> location.href='../../tarefa-visualizar.php'; alert('Etapa não finalizada'); </script>");
}
