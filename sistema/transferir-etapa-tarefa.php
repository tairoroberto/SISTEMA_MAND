...
<script type="text/javascript">
  function enviarTarefa(acao){
    if (acao == 'Atualizar') {
      document.formTarefas.action = "includes/php/TrasferirEtapaTarefa.php";
      document.formTarefas.submit();
    }else{
      document.formTarefas.action = "includes/php/DeletaEtapaTarefa.php";
      document.formTarefas.submit();
    }    
      ...
      <form name="formTarefas" id="formTarefas" method="POST" >
            ...
            <div class="content">
              <div class="page-title"> 
                <h3>Editar - <span class="semi-bold">Fase</span></h3>
              </div>
              <!-- START FORM -->
              <div class="row">
                <div class="col-md-24">
                  <div class="grid simple">
                    ...
                    /********************************************************************************************/
                        ...
                        $buscarEtapaTarefa->set('sql',"SELECT EtapaTarefa.*, Usuarios.* 
                                                       ...
                                                       WHERE  Usuarios.IdUsuario = EtapaTarefa.IdUsuario AND
                                                              EtapaTarefa.IdEtapaTarefa = '$IdEtapaTarefa'
                   ...
                   <div class="row form-row">
                    ...
                    <div class="col-md-2">
                      ...
                      <input type="hidden" name="IdEtapaTarefaAux[]" id="IdEtapaTarefaAux[]" value="<?php echo $retornoEtapaTarefa->IdEtapaTarefa; ?>" readonly="true">

                      <div class="col-md-2">
                        <input name="TituloArray[]" id="TituloArray[]" type="text"  class="form-control" placeholder="Titulo "
                                  value="<?php echo $retornoEtapaTarefa->TituloEtapa; ?>" readonly="true">
                      </div>
                      <div class="col-md-6">
                        <input name="DescricaoArray[]" id="DescricaoArray[]" type="text"  class="form-control" placeholder="Descrição "
                                  value="<?php echo $retornoEtapaTarefa->DescricaoEtapa; ?>" readonly="true">
                      </div>
                      <div class="col-md-2">
                        <input name="DataEntregaArray[]" id="DataEntregaArray[]" type="text"  class="form-control" placeholder="Data entrega "
                                  value="<?php echo $retornoEtapaTarefa->DataEntregaEtapa; ?>" readonly="true">
                      </div>
                    ...
                    <input type="hidden" name="IdEtapaTarefaAux" id="IdEtapaTarefaAux" value="<?php echo $IdEtapaTarefa; ?>">  
                   ...
                   <div class="pull-left"></div>
                      <div class="pull-right">
                         <button class="btn btn-primary btn-cons" type="button"
                                    onclick="validaTarefa();enviarTarefa('Atualizar');">Tranferir Etapa </button>                         
                          <button class="btn btn-danger btn-cons" type="button"
                                    onclick="enviarTarefa('Excluir');">Excluir Etapa</button>
                        </div>
                      </div>
                    </form>
                  </div>
