                ...
                <div class="col-md-12">
                  <div class="grid simple">
                    ...
                    <form class="form-no-horizontal-spacing" id="forOrcamentoBCadastro" name="forOrcamentoBCadastro" method="POST"
                                          action="includes/php/CadastraOrcamentoB.php">
                       <?php 
                                  /********************************************************************************************/
                                  ...
                                  $buscaOportunidade->set('sql',"SELECT CadastraOrcamentoA.*, Oportunidade.* 
                                                                 FROM Oportunidade
                                                                 INNER JOIN CadastraOrcamentoA
                                                                 ON CadastraOrcamentoA.IdOportunidade = $IdOportunidade AND 
                        ...
                        <div class="col-md-6">
                          <h4>Serviçcos</h4>                          
                             ...
                             <?php                     
                                ...
                                /********************************************************************************************/                 
                                    $buscarServicosOrcamentoA = new Conexao();
                                    $buscarServicosOrcamentoA->conectar();
                                    $buscarServicosOrcamentoA->selecionarDB(); 
                                    $cont = 1;
                                                                            
                                    $buscarServicosOrcamentoA->set('sql',"SELECT OrcamentoAServicos.*,Servicos.* 
                                                                          FROM Servicos
                                                                          INNER JOIN OrcamentoAServicos                                                                                  
                                                                          ON OrcamentoAServicos.IdOrcamentoA = $retornoOportunidade->IdOrcamentoA AND 
                                                                             OrcamentoAServicos.IdOportunidade  = $IdOportunidade AND 
                                                                             OrcamentoAServicos.IdServico = Servicos.IdServico
                                                                          GROUP BY IdOrcamentoAServico"); 
                                                     
                                    $query= $buscarServicosOrcamentoA->executarQuery();
                                    while($retornoServicosOrcamentoA = mysql_fetch_object($query)) { ?> 

                                        <div class="row form-row">
                                           <div class="col-md-8">
                                              <label class="form-label">Serviço <?php echo $cont; ?></label>
                                                <input type="text" name="Servico[]" id="Servico[]" 
                                                        readonly="true" value="<?php echo $retornoServicosOrcamentoA->TituloServico; ?>" >
                                                <input type="hidden" name="ServicoArray[]" id="ServicoArray[]" value="<?php echo $retornoServicosOrcamentoA->IdServico; ?>">
                                           </div>
                                           <div class="col-md-4">
                                                <label class="form-label">Valor</label>
                                                <input name="ValorArray[]" id="ValorArray[]" type="text"  class="form-control" value="<?php echo $retornoServicosOrcamentoA->Valor; ?>" 
                          ...
                          <div class="row form-row">
                            ...
                            <div class="col-md-4">
                              <input  id="TotalOrcamentoB" name ="TotalOrcamentoB" type="text" class="form-control" value="<?php echo $retornoOportunidade->TotalOrcamentoA;?>" readonly="true">
                  ...
                  <!--MODELO FORMULARIO 1 COLUNA -->
                            ...
                            <div class="row form-row">
                               ...
                               <div class="col-md-8">
                                ...
                                <div class="col-md-4">
                                          ...
                                          onmouseover="somarValoresOrcamentoB();" value="<?php echo $retornoOportunidade->DataOrcamentoA;?>" readonly="true">
                               </div>
                            </div>
                         ...
                         <div class="row form-row">
                          ...
                          <input type="hidden" name="IdOrcamentoAAux" id="IdOrcamentoAAux" value="<?php echo $retornoOportunidade->IdOrcamentoA;?>">
