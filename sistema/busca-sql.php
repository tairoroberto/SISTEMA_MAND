...
<!-- END HEADER -->
 ...
 <div class="page-content">
        ...
        <div class="content">
          <div class="row-fluid">
          <form id="imoveisLista" name="imoveisLista" method="post" action="imovel-ficha-tecnica">
          <div class="page-title"> 
             <h3>Busca - <span class="semi-bold">Sql</span></h3>
          </div>
            <div class="span12">
              <div class="grid simple ">
                ...
                <div class="grid-body ">
                  <table class="table table-hover table-condensed" id="example">
                    ...
                    /*******************************************************************************************/
                       ...
                       $buscarImovel->set('sql'," SELECT * FROM CadastraImovel 
                                                  WHERE NumeroContribuinte = '$SqlImovel'");
                       
                        $query= $buscarImovel->executarQuery();
                       while($retorno=mysql_fetch_object($query)) { ?> 
                         <tr >
                           <td onclick="selecionaImovel(<?php echo $retorno->IdImovel ?>); document.forms[0].submit();"><a><i class="fa fa-paste"></i></a></td>
                           <td class="v-align-middle" ><?php echo $retorno->MatriculaContribuinte ?></td> <!-- VEr de onde virá SQL-->
                  ...
                  <div><input type="hidden" name="imovelAux" id="imovelAux" ></div>
                </div>
              </div>
            </div>
            </form>
