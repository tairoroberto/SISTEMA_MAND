...
<script type="text/javascript">
  function enviaFormImovelLista(num){
      imoveisLista.imovelAux.value = num;
      imoveisLista.submit();
  }
</script>
</head>
 ...
 <div class="page-content">
        ...
        <div class="content">
          ...
          <div class="page-title"> 
             <h3>Visualizar - <span class="semi-bold">Imoveis</span></h3>
          </div>
            <div class="span12">
                  ...
                  <table class="table table-hover table-condensed" id="example">
                    ...
                    /*******************************************************************************************/
                       ...
                       while($retorno=mysql_fetch_object($query)) { ?> 
                         <tr >
                           <td onclick="enviaFormImovelLista(<?php echo $retorno->IdImovel ?>);"><a href="#"><i class="fa fa-paste"></i></a></td>
